...
پەنجەرەیەک لە خوارەوە یان لای تەنیشت دەکرێتەوە. لە بەشی **Styles**دا،
لەتەنیشت هەر ڕێسایەکی CSS **چوارگۆشەیەکی بچووک (چێکبۆکس)** هەیە.

کلیک لەسەر `<div class="card">` بکە لە بەشی HTMLدا، پاشان ئەم سێ ڕێسایە
یەک بە یەک **لابدە** — و سەیری پەڕەکە بکە:

...
لەسەر پەڕەکە **کلیکی ڕاست** بکە → **Inspect**

پەنجەرەیەک دەکرێتەوە کە دوو بەشی سەرەکی هەیە:

- **بەشی سەرەوە (یان چەپ)** — HTMLی پەڕەکە
- **بەشی Styles** — CSSەکەی

### ١. کلیک لەسەر سندوقەکە بکە

لە بەشی HTMLدا، ئەم دێڕە بدۆزەرەوە و کلیکی لێبکە:

```
<div class="card">
```

### ٢. ئێستا سەیری بەشی Styles بکە

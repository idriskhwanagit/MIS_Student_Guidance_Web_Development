...
٢. **کۆدەکان لە کاتی پراکتیکیدا دەتوانیت کۆپی بکەیت**، بەڵام ئەگەر بە تەنیا بوویت هەوڵبدە بینووسیتەوە — تاکو شارەزابوونت لە کۆدینگ زیاد بکات.
...
> **دوگمەی کۆپی چی دەکات؟** لەو سندوقانەی ڕەنگیان تێدایە، دوگمەکە
> **هەموو ئەو بەشە** کۆپی دەکات وەک دەبێت **دوای گۆڕانکاری** بێت — واتە
> دێڕە سەوزەکان لەگەڵ ئەو دێڕە بێ‌ڕەنگانەی دەوروبەریان، بەڵام بەبێ ئەو
> دێڕانەی هێڵیان بەسەردایە.
>
> **بۆچی تەنها سەوزەکان نا؟** چونکە دێڕە سەوزەکان بە تەنها پارچەن — نازانیت
> لە فایلەکەدا لە کوێ دایاننێیت. بەڵام بەشەکە بە تەواوی، شوێنی خۆی
> پیشان دەدات.
>
> بۆیە: ئەو بەشە لە فایلەکەتدا **دیاری بکە و لەسەری دابنێ** — نەک تەنها
> لە شوێنی نیشانەکە دایبنێیت.
...
| **دێڕە سەوزەکان** | ئەوانەی **تۆ زیادیان دەکەیت**. دێڕە بێ‌ڕەنگەکان پێشتر لە فایلەکەدان — تەنها بۆ ئەوەن بزانیت کوێ |
| **دێڕی هێڵ‌بەسەردا** | ئەوەی **دەبێت بسڕدرێتەوە** |
...
| **بیگۆڕە** | بەشێکی فایلەکە دەگۆڕێت | ئەو بەشە لە فایلەکەدا بدۆزەوە و **لەسەری دابنێ** |

> ### ⚠️ دوای هەر «بیگۆڕە»یەک، ئەمە بپشکنە
>
> کۆپییەکە **لەسەر** بەشە کۆنەکە دابنێ — نەک لە جێی نیشانەکە.
>
> بۆ دڵنیابوونەوە: `Ctrl + F` لێبدە و ناوی ئەو فەنکشنەی گۆڕیت بنووسە
> (بۆ نموونە `def page_home`). VS Code لای ڕاست ژمارەی دۆزینەوەکان
> پیشان دەدات — **دەبێت ١ بێت**.
>
> ئەگەر ٢ بوو، دووبارەت کردووەتەوە. **Python بێدەنگ دووەمیان
> هەڵدەبژێرێت** و یەکەمیان پشتگوێ دەخات — بۆیە کۆدەکە ڕاست دیارە و
> کار ناکات.
...
### ڕێگای خێرا — لە تێرمیناڵەوە

لەبری ئەو شەش هەنگاوەی سەرەوە، دەتوانیت Python بە یەک فەرمان دابەزێنیت. لە
تێرمیناڵی VS Code ئەمە بنووسە:

```bash
winget install -e --id Python.Python.3.14 --custom "PrependPath=1"
```

فەرمانی `winget` خۆی Python دادەبەزێنێت، و بەشی `PrependPath=1` هەمان کاری
چوارگۆشەی **Add python.exe to PATH** دەکات — پێویست ناکات هیچ شتێک نیشان بکەیت.

پاشان **VS Code بە تەواوی دابخە و دووبارە بیکەرەوە**، و لە تێرمیناڵێکی
نوێدا فەرمانی `python --version` بنووسە.

> ئەگەر تێرمیناڵ دەڵێت `winget` نەناسراوە، ئەم کۆمپیوتەرە ئەو فەرمانەی نییە —
> ڕێگای سەرەوە بەکاربهێنە.

**ئەگەر VS Code یشت نییە:** کلیکی ڕاست لە دوگمەی **Start** بکە ← **Terminal**،
و ئەمە بنووسە:
...
| ٤ | تێرمیناڵێکی نوێ بکەرەوە (`+`) و `netstat -ano | findstr :8000` بنووسە، پاشان `taskkill /PID <ژمارەکە> /F` |
...
> ### 🐢 ئەگەر پەڕەکە خاو دێت
>
> لەسەر هەندێک کۆمپیوتەر، هەر داواکارییەک نزیکەی **٠.٢ چرکە** درەنگ دەکەوێت.
> پەڕەکە دێت، بەڵام هەست بە خاوی دەکەیت.
>
> **کۆدەکەت خراپ نییە.** ناوی `localhost` دوو ناونیشانی هەیە: یەکێکی نوێ
> (`::1`) و یەکێکی کۆن (`127.0.0.1`). وێبگەڕ سەرەتا نوێیەکە تاقی دەکاتەوە،
> بەڵام سێرڤەرەکەی ئێمە تەنها لەسەر کۆنەکە گوێ دەگرێت — بۆیە وێبگەڕ چاوەڕێ
> دەکات، پاشان دەگەڕێتەوە.
>
> **چارەسەر:** لەبری `localhost` ئەمە بەکاربهێنە:
>
> ```
> http://127.0.0.1:8000
> ```
>
> هەمان سێرڤەرە. تەنها ڕێگەیەکی خاوی لادەبات. لە وێبگەڕدا وەک **Bookmark**
> پاشەکەوتی بکە.
...
| پەڕەکە دێت، بەڵام **زۆر خاوە** (چەند چرکەیەک) | لەبری `localhost:8000` ئەمە بەکاربهێنە: `127.0.0.1:8000` (بڕوانە ٣.٥) |
...
**چارەسەر:** دوا ژمارەی هەر دێڕێک **PID**ـە — ناسنامەی ئەو پڕۆسەیە.
لە نموونەی سەرەوەدا `28836`ـە. بیکوژە:

```bash
taskkill /PID 28836 /F
```

> **ژمارەکە بگۆڕە** بەو ژمارەیەی لای خۆت. هەر دێڕێک ژمارەیەکی جیای هەیە.
...
پاشان دیسان `netstat -ano | findstr :8000` بکە — دەبێت **هیچ** دەرنەکەوێت.
ئینجا `python app.py`.

> ### بۆچی بە PID، نەک بە ناو؟
>
> لەوانەیە `taskkill /IM python.exe /F` ببینیت لە شوێنی تر. ئەو فەرمانە
> هەموو Pythonـەکان دەکوژێت **بە ناوی فایلەکە** — بەڵام ئەگەر Pythonت لە
> **Microsoft Store**ـەوە دابەزێنرابێت، ناوەکەی `python3.13.exe`ـە نەک
> `python.exe`، و ئەم پەیامە دەبینیت:
>
> ```out
> ERROR: The process "python.exe" not found.
> ```
>
> **PID هەمیشە کاردەکات** — لە هەر شێوەیەکی Python بێت.
...
| ئەگەر ئەمەت گۆڕی | ئەوا ئەمە بکە |
|-------------------|----------------|
| فایلێکی HTML لە فۆڵدەری `templates` | تەنها `F5` لە وێبگەڕدا |
| `app.py` یان `database.py` | `Ctrl + C` ← `python app.py` ← `F5` |

> **هۆکارەکەی:** `render()` فایلی HTML لە **هەر داواکارییەکدا** دەخوێنێتەوە،
> بۆیە گۆڕانکارییەکە یەکسەر دەردەکەوێت. بەڵام کۆدی Python تەنها **یەک جار**
> دەخوێنرێتەوە — لە کاتی هەڵسانی سێرڤەرەکەدا.
...
### ئێستا هەردوو کۆمێنتەکە **بە تەواوی** بسڕەوە
...
| `* { box-sizing: border-box }` | پانی ئەلیمێنت بە پەراوێز و کەنارەوە دەژمێردرێت — بەبێ ئەمە دیزاینەکان تێکبچن |
...
## ٦.٦.١ — هەر ڕێسایەک چی دەکات؟ خۆت بیبینە

خشتەی ٦.١.١ باسی هەر ڕێسایەک دەکات. بەڵام **بینین باشترە لە خوێندنەوە**.

### ١. کلیکی ڕاست بکە **لەسەر خودی سندوقە سپییەکە**

نەک لە شوێنێکی بەتاڵی پەڕەکە — لەسەر خودی سندوقەکە. پاشان **Inspect**.

> **بۆچی لەسەر خودی سندوقەکە؟** چونکە ئەوسا وێبگەڕ **خۆی** ئەو بەشە
> هەڵدەبژێرێت کە کلیکت لێکردووە. ئەگەر لە شوێنێکی تر کلیک بکەیت، دەبێت
> خۆت بەدوایدا بگەڕێیت.
...
**Elements** ئەوەیە کە دەتەوێت — بە بنەڕەت کراوەتەوە. لەناویدا دوو بەش
هەیە:

| بەش | چی تێدایە |
|-----|-----------|
| **Elements** (سەرەوە یان چەپ) | HTMLی پەڕەکە، وەک دارێک |
| **Styles** (خوارەوە یان ڕاست) | CSSی ئەو بەشەی هەڵبژێردراوە |
...
سێ شت لێرەدا فێر دەبیت:

| ئەوەی دەبینیت | واتای |
|----------------|-------|
| `.card { ... }` | هەمان ئەو ڕێسایەی لە `style.css`دا نووسیوتە |
| `style.css:34` | **کام فایل و کام دێڕ** — کلیکی لێبکە، ڕاستەوخۆ دەتباتەوە بۆ ئەو دێڕە |
| ☑ لەتەنیشت هەر دێڕێک | چێکبۆکس — دەتوانیت لای بدەیت |

> **ئەمە باشترین ئامرازە بۆ فێربوونی CSS.** ئەگەر ڕۆژێک ڕێسایەکت کاری
> نەکرد، لێرەدا دەبینیت ئایا بەڕاستی گەیشتووە بۆ ئەلیمێنتەکە یان نا.

### ٤. ئێستا چێکبۆکسەکان لابدە

ئەم سێ ڕێسایە یەک بە یەک **لابدە** — و سەیری پەڕەکە بکە:

| ئەمە لابدە | چی ڕوودەدات |
|-------------|--------------|
| `background` | سندوقە سپییەکە **ون دەبێت** — ڕەنگی پاشبنەما دەردەکەوێت |
| `border-radius` | گۆشەکان **تیژ دەبن** |
| `padding` | دەقەکە **دەلکێت** بە کەنارەکەوە |

`padding` بەرچاوترینیانە. کاتێک لادەبرێت، یەکسەر تێدەگەیت بۆچی لەوێیە.

> ### 🤔 فایلەکەم شکاند؟
>
> **نەخێر.** فایلی `style.css` **هەرگیز نەگۆڕدراوە**. ئەو گۆڕانکارییەکان
> تەنها لە **بیری وێبگەڕەکەدان**.
>
> **`F5`** لێبدە ← هەموویان دەگەڕێنەوە.

> **ئەمە ئامرازی کارە، نەک تەنها فێرکاری.** هەموو ئەوانەی وێب دروست دەکەن،
> CSSەکەیان لێرەدا تاقی دەکەنەوە — پاشان ئەوەی کاری کرد دەنووسنە ناو
> فایلەکەوە.
...
ئێستا سێ حاڵەتت هەیە — ئەمە خشتەی تەواوە:

| ئەگەر ئەمەت گۆڕی | ئەوا ئەمە بکە |
|-------------------|----------------|
| فایلێکی HTML لە `templates` | `F5` |
...
> ئەم دوو دێڕە درێژن و لە پڕۆژەکەدا نامێننەوە — تەنها داتای تاقیکردنەوەن.
> لێرەدا **کۆپیکردن ڕێگەپێدراوە**.

## چی دەبینیت

**هیچ.** تێرمیناڵ دێڕێکی بەتاڵ پیشان دەدات و دەگەڕێتەوە بۆ `>`.

ئەمە هەڵە نییە. Python هیچ ناڵێت مەگەر پێی بڵێیت بیڵێت — و ئێمە پێمان
نەگوتووە. `add_student()` قوتابییەکە تۆمار دەکات، بەڵام هیچ ناپرینتێت.

> ئەگەر پەیامێکی سووری درێژت بینی کە بە `Traceback`ـەوە دەست پێدەکات،
> ئەوە هەڵەیە. سەیری **دوا دێڕەکەی** بکە — لەوێدا هۆکارەکە نووسراوە.
...
فەرمانەکانی سەرەوە هیچیان نەگوت، بۆیە دەبێت خۆمان پرسیار بکەین: **چی چووە
ناو داتابەیسەکەوە؟**
...
| ئەگەر ئەمەت بینی | واتای |
|------------------|-------|
| `2 students` | هەردوو فەرمانەکە کاریان کرد ✅ |
| `0 students` | هیچ زیاد نەبووە — فەرمانەکانی سەرەوە دووبارە بکەرەوە |
| `1 students` | تەنها یەکێکیان کاری کرد — ئەوی تر دووبارە بکەرەوە |
| `no such table` | `init_db()` نەکراوە — فەرمانی یەکەم دووبارە بکەرەوە |

> **سارا بۆچی یەکەمە؟** چونکە `ORDER BY id DESC` — نوێترین لە سەرەوە.
> ئەمە لە ٧.١دا نووسیمان.

> ئەم فەرمانە **هیچ ناگۆڕێت** — تەنها دەخوێنێتەوە. هەر کاتێک دڵنیا نەبوویت
> چی لە داتابەیسەکەدایە، دەتوانیت بەکاری بهێنیت.
...
> **ئێستا هیچ ناگۆڕێت.** ئەم فایلە دروست بوو، بەڵام هێشتا کەس بانگی ناکات —
> لە ٧.٦دا بانگی دەکەین. ئەگەر ئێستا `F5` لێبدەیت، پەڕەکە وەک خۆیەتی.
...
**سێرڤەرەکە دووبارە مەکەرەوە.** تەنها `F5` لە وێبگەڕدا.
...
**دەقێکی بەتاڵ** دەیگۆڕێتەوە — هەڵە نادات.

> پەڕەکە ئێستا کەم‌ناوەڕۆکە. ئەمە بەئەنقەستە و **نیشانەی ئەوەیە کە
> گۆڕانکارییەکەت کاری کردووە**. لە ٧.٦دا `table` پڕ دەکەینەوە.
...
`Ctrl + S` بکە، پاشان سێرڤەرەکە دووبارە بکەرەوە:
...
**پەڕەکە هیچی ناگۆڕێت** — و ئەمە ڕاستە. دوو فەنکشنەکە نووسران، بەڵام
هێشتا **کەس بانگیان ناکات**. لە ٧.٦دا بانگیان دەکەین.

**کەواتە ئەنجامی ئەم بەشە چییە؟** ئەوەی سێرڤەرەکە **دەست پێدەکات**. ئەگەر
بۆشاییەکانت هەڵە بوونایە، لێرەدا دەردەکەوت — نەک دوو بەش دواتر.

| ئەگەر ئەمەت بینی | واتای |
|------------------|-------|
| `Server running at ...` | هەموو شتێک ڕاستە ✅ |
| `IndentationError` | بۆشایی لەپێش `def`ـەکە هەیە — دەبێت لە چەپەوە دەست پێبکات |
| `SyntaxError` | پەرانتێزێکی `)` یان `"""`ـێک داخراو نییە. ژمارەی دێڕەکە لە پەیامەکەدایە |
| `unexpected indent` | دێڕەکانی ناو فەنکشنەکە یەک ڕیز نین — ٤ بۆشایی بەکاربهێنە |

> **`import html`ت لەبیر نەچێت.** ئەگەر زیادت نەکردبێت، سێرڤەرەکە بێ کێشە
> دەست پێدەکات — چونکە `esc()` هێشتا بانگ نەکراوە. هەڵەکە تەنها لە ٧.٨دا
> دەردەکەوێت، وەک `NameError: name 'html' is not defined`.
...
> ### ⚠️ سەرەتا دڵنیابە لە کام فایلدایت
>
> ئەمە دەچێتە ناو **`database.py`**ـەوە — نەک `app.py`. لە کۆتایی ئەو
> فایلەدا دایبنێ، لەژێر `get_all_students()`.
>
> **ئەگەر بە هەڵە خستتە ناو `app.py`ـەوە**، دوو نیشانە دەیبینیت:
>
> ١. ژێرهێڵێکی زەرد لەژێر `get_connection()` — VS Code دەڵێت «ئەم ناوە
> لێرەدا بوونی نییە»، چونکە لە `database.py`دا نووسراوە.
>
> ٢. هەرچی لەژێر `server.serve_forever()`ـەوە بێت، **هەرگیز کار ناکات** —
> ئەو دێڕە بۆ هەمیشە چاوەڕێ دەکات و Python هەرگیز پێی ناگات.
>
> چارەسەر: لە `app.py` بیسڕەوە و لە کۆتایی `database.py` دایبنێ.
...
ئەم فەنکشنە هێشتا کەس بانگی ناکات، بەڵام **دەتوانیت ئێستا تاقی بکەیتەوە**.
سێرڤەرەکە بوەستێنە و ئەمە بنووسە:
...
| وەڵام | بۆچی |
|-------|------|
| **`True`** | `MIS-2025-001` پێشتر هەیە — لە ٧.٢دا زیادمان کرد |
| **`False`** | `MIS-9999-999` بوونی نییە |

> **ئەمە بەڵگەیە کە فەنکشنەکە کاردەکات** — و هەروەها بەڵگەیە کە لە فایلی
> ڕاستدایە. ئەگەر خستبووتە ناو `app.py`ـەوە، ئەم فەرمانە هەڵە دەدات.

> ئەمە هەروەها پیشانت دەدات کە `database.py` **بە تەنها کاردەکات** — پێویستی
> بە سێرڤەر نییە. ئەمە سوودی جیاکردنەوەی ئەرکەکانە کە لە ٤.٠دا باسمان کرد.
...
**هیچ — هێشتا.** ئەم فایلە دروست بوو، بەڵام هێشتا هیچ ڕێڕەوێک بۆی نییە.
ئەگەر ئێستا `localhost:8000/add` بکەیتەوە، `404` دەبینیت. لە ٨.٦دا
ڕێڕەوەکە دروست دەکەین.

**بەڵام ئەمە بپشکنە:** فایلەکە دەبێت **لەناو فۆڵدەری `templates`**دا بێت،
نەک لەتەنیشت `app.py`. لە Explorerدا وا دەبێت:
...
> ئەگەر لە شوێنی هەڵەدا بێت، لە ٨.٦دا هەڵەی
> `FileNotFoundError: form.html` دەدات. لە Explorerدا بە ماوس
> ڕایبکێشە بۆ ناو `templates`.
...
> ### ⚠️ ئەگەر پێشتر `do_POST`ت هەیە
>
> **دووەمی زیاد مەکە.** سەرەتا بە `Ctrl + F` بگەڕێ بۆ `do_POST`.
>
> ئەگەر پێشتر هەبوو، تەنها ئەو دێڕانەی کەمن زیاد بکە — نەک هەموو فەنکشنەکە.
>
> **بۆچی گرنگە:** ئەگەر دوو فەنکشن بە یەک ناو هەبن، Python **دووەمیان**
> بەکاردەهێنێت و یەکەمیان پشتگوێ دەخات — **بەبێ هیچ پەیامێکی هەڵە**.
> ئەمە دۆزینەوەی زۆر سەختە: کۆدەکە ڕاست دیارە، بەڵام کار ناکات.
...
**٥. `id`ـێکی نەبوو داوا بکە.** ئەمە **لە وێبگەڕدا** بکەرەوە — نەک لە
تێرمیناڵ:
...
| دێڕەکان زیاد کراون بەڵام هێشتا `404` دەدات | **دوو `do_POST`**ت هەیە. `Ctrl + F` ← `do_POST`. دووەمیان بسڕەوە |
...
**٥. تاقیکردنەوەی یاساکە.** ئەمە **لە وێبگەڕدا** بکەرەوە — نەک لە
تێرمیناڵ:
...
دەبێت **`404`** ببینیت، و **هیچ نەسڕدرێتەوە** —
...
> ئەو `?`ـانەی لە ١١.١دا نووسیمان، لە **SQL Injection** دەپارێزن. بەڵام
> ئێستا تاقیکردنەوەکەی هیچ پیشانت نادات — «هیچ نەدۆزرایەوە» وەک هەر
> گەڕانێکی بێ ئەنجام وایە. لە **هەنگاوی ١٢**دا ئەو پاراستنە لادەبەین و
> هێرشەکە **بە چاوی خۆت دەبینیت** — ئەوسا واتای پەیدا دەکات.
...
### بۆچی؟ — ئەمە گرنگترین خاڵی هەنگاوەکەیە

کۆدە مەترسیدارەکە دەقەکەی تۆ **ڕاستەوخۆ خستە ناو فەرمانەکەوە**:
...
تۆ نووسیت `' OR '1'='1`، بۆیە فەرمانەکە بوو بە:

```sql
SELECT * FROM students WHERE full_name LIKE '%' OR '1'='1%' ORDER BY id DESC
```

سەیری ناوەڕاستەکەی بکە:

```out
WHERE full_name LIKE '%'   OR   '1'='1%'
                      ↑         ↑
                      │         └── ئەمە تۆ زیادت کرد
                      └── ئەم کۆتەیە پێویست بوو
                          دەقەکەت داخرابا... بەڵام تۆ
                          خۆت کۆتەیەکت نووسی و داتخست
```

**ئەو کۆتەیەی (`'`) لە سەرەتای نووسینەکەت، کۆتەکەی ناو فەرمانەکەی داخست.**
لەو ساتەوە، هەرچی دوای ئەو نووسیت، SQLite وەک **فەرمان** لێی ڕوانی — نەک
وەک دەق.

پاشان `'1'='1` **هەمیشە ڕاستە**، و `OR` واتای «یان ئەمە یان ئەوی تر» —
بۆیە بۆ هەموو ڕیزێک ڕاستە، و هەموویان دەگەڕێنەوە.

> **کورتی خاڵەکە:** بەکارهێنەر تەنها داتای نەنووسیوە — **بەشێکی فەرمانەکەی
> نووسیوە**.

### لە جیهانی ڕاستەقینەدا

| ئەگەر ئەمە بنووسرێت | ئەنجام |
|---------------------|--------|
| `' OR '1'='1` لە خانەی وشەی نهێنیدا | چوونەژوورەوە بەبێ وشەی نهێنی |
| `'; DROP TABLE students; --` | خشتەکە دەسڕدرێتەوە |
| `' UNION SELECT password FROM users --` | وشە نهێنییەکان دەردەکەون |

ئەمە **کۆنترین و باوترین** هێرشی وێبە — و هێشتا هەموو ساڵێک ڕوودەدات.
...
| هەموو پەڕەیەک **خاو** دێت | `127.0.0.1:8000` بەکاربهێنە، نەک `localhost:8000` (بڕوانە ٣.٥) |
